#ifndef __LRU_H_INCLUDED__
#define __LRU_H_INCLUDED__
#include<iostream>
#include<vector>
#include<string>
#include<time.h>
...
int lru::already_in_frame(int page) {
...
void lru::change_victim_page(int page,int last) {
